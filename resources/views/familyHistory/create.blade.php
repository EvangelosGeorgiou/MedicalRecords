...
<div class="move-context">
    <div class="card container">
        ...
        <div class="card-body">
            ...
            <form
                action="{{ isset($familyHistory) ? route('familyHistory.update',$familyHistory->id) : route('familyHistory.store') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="family_side" id="family_side" class="form-control">
                                ...
                                <option value="Mother's" @if(isset($familyHistory) && $familyHistory->
                                    family_side=='Mother\'s') selected @endif>Mother</option>
                                <option value="Father's" @if(isset($familyHistory) && $familyHistory->
                                    family_side=='Father\'s') selected @endif>Father</option>
                            </select>
                        </div>

                        <button class="btn btn-success"
                            type="submit">{{isset($familyHistory) ? 'Update Family History ' : 'Add Family History'}}</button>
                    </div>
